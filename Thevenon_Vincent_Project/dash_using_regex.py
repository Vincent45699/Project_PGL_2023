...
# get data for ethereum and pax-gold
...
app.layout = html.Div(children=[    html.Div(children=[        
    ...
    html.Div(children=[        
        html.Div(children=[            
            html.H4(children='Current Price of the ETH:', 
        ...
        html.Div(children=[            
            html.H6(children='Current Price of the PAX Gold:', 
                    style={'textAlign': 'center'}),            
        ...
        html.Div(children=[        dcc.Graph(            id='ethereum-price',            figure={                'data': [                    go.Scatter(x=[x[0] for x in eth_historical_data], y=[y[1] for y in eth_historical_data], mode='lines', name='Ethereum price', line={'color': '#2B2D42'}),
                    # Add pax-gold data to the graph
    ...
    html.Div(children=[
        html.Div(children=[
            ...
            html.Table(
                [html.Tr([html.Th(metric['name'], style={'padding': '10px'})]) for metric in report_data_eth],
